...
public class WUtil {
	public static Object getData(String loc) throws IOException {
		...
		urlBuilder.append("?" + URLEncoder.encode("serviceKey", "UTF-8") + "=WiITGCLWUk3w2IyhvC%2BNhDIKb995fQgd1GS0wKaHSVmSs1hdC0Ocb9BN%2Fd8we8bz25NOphOYW4vpgbmLMZ7RUA%3D%3D"); /* Service Key */
		...
		urlBuilder.append("&" + URLEncoder.encode("stnId", "UTF-8") + "="
				+ URLEncoder.encode(loc, "UTF-8")); /* 108 전국, 109 서울, 인천, 경기도 등 (활용가이드 하단 참고자료 참조) */
		urlBuilder.append("&" + URLEncoder.encode("tmFc", "UTF-8") + "=" + URLEncoder.encode("202301180600",
