...
public class FileUtil {
     ...
     * @param nameFormat 이미지파일명 포멧. {@link String#format}을 따르고 pdfPageNo가 arguments로 제공됨 ex)"img_%s.png"
     ...
     * @param source 변환할 PDF 파일
     * @param destination 저장할 폴더 경로
     * @param nameFormat 이미지파일명 포멧. {@link String#format}을 따르고 pdfPageNo가 arguments로 제공됨 ex)"img_%d.png"
     * @param imageFormat png, jpg, jpeg, gif
     * @param startIndex 이미지 생성 시작 페이지 index
     * @param endIndex 이미지 생성 마지막 페이지 index, not include
